  ...
  return (
    ...
    <section className='w-full bg-dull flex flex-col items-center justify-center h-full'>
        <div className='w-full h-full absolute flex items-center justify-center' style={{zIndex : 1}}>
          <img className='w-full h-full' src="https://images.unsplash.com/photo-1738831920727-73e17adc5b87?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" srcset="" />
          {/* <GridDistortion
      ...
      <div className='w-7/10 max-sm:w-full h-full flex flex-col items-start justify-start pointer-events-none relative' style={{zIndex : "3"}}>
        ...
        <nav className='flex items-center justify-between h-20 w-full max-sm:px-3'>
          ...
          <motion.button initial={{x : 20, opacity : 0}} animate={{x : 0, opacity : 100}} transition={{delay : 0.3}} className='px-7 py-3 max-sm:px-4 max-sm:py-2 bg-white rounded-full font-poppins relative overflow-hidden flex items-center justify-center group transition-all cursor-pointer pointer-events-auto'>
        ...
        <div className='w-full flex items-center justify-center flex-col h-6/10 relative max-md:h-4/10 max-md:justify-end max-sm:-translate-y-3'>
          ...
          <div className='flex items-center justify-center flex-col relative'>
            ...
            <motion.h1 initial={{y : 20, opacity : 0}} animate={{y : 0, opacity : 100}} transition={{delay : 0.5}} className='font-future text-primary tracking-wider text-[8.5rem] max-md:text-[6rem] max-sm:text-[5rem]' style={{lineHeight : '1.3'}}>AHMAD</motion.h1>

            <motion.img initial={{scale : 1.15, opacity : 0}} animate={{scale : 1, opacity : 100}} transition={{delay : 0.7}} className='w-60 h-60 max-md:w-42 max-md:h-42 max-md:p-2 rounded-full object-contain object-center aspect-square absolute bg-primary-translucent p-3' style={{boxShadow : "0 0 20px 0px #000000"}} src={PicThree} alt="" />
          </div>
