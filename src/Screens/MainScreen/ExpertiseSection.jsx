  ...
  return (
    ...
    <section className='w-full flex flex-col items-center justify-start h-screen relative' >
        ...
        <div className='w-full h-full flex flex-col items-center justify-start py-10 bg-dull'>
            ...
            <div className='w-6/10 h-8/10 flex items-start justify-center mt-12 flex-wrap max-md:w-full'>

              <div className='w-3/4 flex items-center justify-center relative'>

                <button onClick={() => setBackendActive(false)} className={`text-xl text-primary w-1/2 h-full py-2 rounded-md transition-all duration-200 ${isBackendActive ? 'bg-transparent' : 'bg-[#fca2112f]'}`}>Frontend</button>
                
                <button onClick={() => setBackendActive(true)} className={`text-xl text-primary w-1/2 h-full py-2 rounded-md transition-all duration-200 ${isBackendActive ? 'bg-[#fca2112f]' : 'bg-transparent'}`}>Backend</button>

              </div>

              <div className='w-full h-8/10 flex items-start justify-start rounded-md p-4 border-[0.5px] border-[#ffffff40]'>

                {
                  isBackendActive ? (
                    ...
                    <motion.div className='flex flex-wrap items-center justify-around h-full w-full'>

                      <div className='w-49 h-45 border-[0.5px] border-[#ffffff30] rounded-md flex items-center justify-center'>
                      ...
                      <div className='w-49 h-45 border-[0.5px] border-[#ffffff30] rounded-md flex items-center justify-center'>
                        <svg className='shadow-md shadow-[#ffffff30] rounded-full' data-testid="geist-icon" height="72" stroke-linejoin="round" style={{color : "currentcolor"}} viewBox="0 0 16 16" width="72"><g clip-path="url(#clip0_872_3186)">
                          <circle cx="8" cy="8" r="7.25" fill="#000000" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></circle>
                          <path fill-rule="evenodd" clip-rule="evenodd" d="M8 4.5L11.5 10.625H4.5L8 4.5Z" fill="#ffffff"></path>
                          </g>
                          <defs>
