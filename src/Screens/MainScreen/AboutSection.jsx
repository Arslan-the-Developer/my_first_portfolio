    ...
    <section className='w-full flex flex-col h-full items-center justify-start bg-transparent py-8 rounded-4xl border-2 border-primary max-sm:border-none' style={{zIndex : 3, boxShadow : "0 0 15px 0px #fca311"}}>
        ...
        <div className='h-full max-md:w-full flex flex-col items-center justify-start'>
          ...
          <div className='w-full flex flex-col items-center justify-center content-center transition-all mt-15'>
            ...
            <span className='w-40 h-[1px] bg-primary mt-12'></span>

            <p className='w-155 max-sm:w-86 max-md:w-120 text-center text-white font-poppins tracking-wide mt-12 font-extralight' style={{lineHeight : 1.9, fontSize : "calc(0.8rem + 0.7vw)"}}>Hey There! I am Arslan Ahmad. I am a Full Stack Web Developer & <span className='px-2 font-normal bg-primary text-dull rounded-sm'>API Expert</span>. I Unleash The Power of -- Programming with over <span className='bg-primary font-normal px-2 rounded-sm text-dull'>3+ Years</span> of strong command on it & deliver secure web solutions.</p>
